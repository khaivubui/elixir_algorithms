defmodule Sort do
  ...
  def merge([], right_list, result), do: result ++ right_list

  def merge(left_list, [], result), do: result ++ left_list

  def merge [l_item | l_remain] = l_list, [r_item | r_remain] = r_list, result do
